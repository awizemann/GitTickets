...
- [deferred] Real `wrangler deploy` + GitHub round-trip verification needs the user to bind R2/KV and set secrets. The contract test catches any wire drift before then. #verification
